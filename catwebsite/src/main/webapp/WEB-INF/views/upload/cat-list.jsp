        ...
        <div class="amado_product_area section-padding-100">
         ...
         <c:forEach begin="0" end="${ fn:length(list)/3 }" varStatus="i">
                    ...
                    <div class="col-8 col-sm-4 col-md-8 col-xl-4">
                        <div class="single-product-wrapper">
                            ...
                            <a href="/catopia/cat-upload/cat-detail/${ list.catNo }" data-toggle="tooltip" data-placement="right" title="고양이 정보보기"> 
                                <img src="/catopia/resources/upload-files/${ list.img.savedImgName }" style="height: 280px; width: 400px;" alt=""></a>
                            </div>
                     ...
                     <!-- Product Description -->
                            <div class="product-description d-flex align-items-center justify-content-between">
                               ...
                               <div class="product-meta-data">
                                   <div class="line"></div>
                                         <p class="product-price">이름 : ${ list.catName }</p>
             ...
             <ul class="pagination justify-content-end mt-50">
                 ...
                 <li class="page-item">
                  <a class="page-link" href="product-listPage${ProductPageMaker.makeQuery(idx)}">뒤로</a>
               </li>    
             </ul>
             </nav>
            </div>  
